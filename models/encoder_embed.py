...
class WindowPool3D(nn.Module):
    ...
    def forward(self, x):
        ...
        # x:
        # [B, E, Nd, Nh, Nw, wd, wh, ww]
        
        B, E, Nd, Nh, Nw, wd, wh, ww = x.shape
        
        # Move each window into the batch dimension
        x = (
            x.permute(0, 2, 3, 4, 1, 5, 6, 7)
             .contiguous()
        )
        
        # x:
        # [B, Nd, Nh, Nw, E, wd, wh, ww]
